...
describe('DocumentService', () => {
    ...
    describe('createDocument', () => {
        test('should create a document successfully', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO documents'), expect.any(Array));
        });
    ...
    describe('getDocumentById', () => {
        ...
        test('should filter by user ID', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('user_id = $2'), ['doc123', 'user123']);
        });
    });
    describe('getDocuments', () => {
        ...
        test('should apply filters', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('user_id = $1 AND status = $2'), ['user123', 'completed', 10, 0]);
        });
    });
    describe('updateDocument', () => {
        test('should update document successfully', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('UPDATE documents'), expect.any(Array));
        });
    ...
    describe('deleteDocument', () => {
        test('should delete document successfully', async () => {
            ...
            expect(mockQuery).toHaveBeenCalledWith(expect.stringContaining('DELETE FROM documents'), ['doc123']);
        });
    ...
    describe('updateDocumentStatus', () => {
        ...
        test('should include error message for failed status', async () => {
            ...
            mockQuery.mockResolvedValueOnce({ rows: [mockRow] });
            const result = await service.updateDocumentStatus('doc123', 'failed', 'Processing failed');
