...
const table_detection_service_1 = require("../../src/services/table-detection.service");
describe('TableDetectionService', () => {
    let service;
    beforeEach(() => {
        service = new table_detection_service_1.TableDetectionService();
    });
    describe('initialization', () => {
        test('should create service instance', () => {
            expect(service).toBeInstanceOf(table_detection_service_1.TableDetectionService);
        });
    ...
    describe('service methods', () => {
        test('should export singleton instance', () => {
            expect(table_detection_service_1.tableDetectionService).toBeInstanceOf(table_detection_service_1.TableDetectionService);
        });
