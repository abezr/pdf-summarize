import { GraphFactory } from '../../src/services/graph';
import { NodeType, EdgeType } from '../../src/models';
...
describe('GraphFactory', () => {
  describe('createNode', () => {
    it('should create a valid node with generated ID and timestamps', () => {
      ...
      const node = GraphFactory.createNode(input);
    ...
    it('should throw error for invalid node type', () => {
      ...
      expect(() => GraphFactory.createNode(input)).toThrow('Invalid node type');
    });
    ...
    it('should throw error for empty label', () => {
      ...
      expect(() => GraphFactory.createNode(input)).toThrow('Node label cannot be empty');
    });
    ...
    it('should throw error for null content', () => {
      ...
      expect(() => GraphFactory.createNode(input)).toThrow('Node content cannot be null or undefined');
    });
    ...
    it('should throw error for invalid position', () => {
      ...
      expect(() => GraphFactory.createNode(input)).toThrow('Invalid position: page must be a positive number');
    });
  });
  ...
  describe('createEdge', () => {
    it('should create a valid edge with generated ID', () => {
      ...
      const edge = GraphFactory.createEdge(input);
    ...
    it('should throw error for self-referencing edge', () => {
      ...
      expect(() => GraphFactory.createEdge(input)).toThrow('Edge cannot reference the same node');
    });
    ...
    it('should throw error for invalid edge type', () => {
      ...
      expect(() => GraphFactory.createEdge(input)).toThrow('Invalid edge type');
    });
  });

  describe('createDocumentNode', () => {
    it('should create a document root node', () => {
      const node = GraphFactory.createDocumentNode('test.pdf', 5, 1024000);
  ...
  describe('createSectionNode', () => {
    it('should create a section node with heading level', () => {
      ...
      const node = GraphFactory.createSectionNode('Introduction', 1, position, 0.9);
  ...
  describe('createParagraphNode', () => {
    it('should create a paragraph node', () => {
      ...
      const node = GraphFactory.createParagraphNode(content, position, 0.8);
    ...
    it('should truncate long paragraph labels', () => {
      ...
      const position = { page: 1, start: 0, end: content.length };
      const node = GraphFactory.createParagraphNode(content, position);
  ...
  describe('createTableNode', () => {
    it('should create a table node with dimensions', () => {
      ...
      const position = { page: 1, start: 0, end: content.length };
      const node = GraphFactory.createTableNode(content, position, 3, 2, 0.7);
  ...
  describe('createImageNode', () => {
    it('should create an image node', () => {
      ...
      const node = GraphFactory.createImageNode('Chart showing data', position, dimensions, 0.6);
    ...
    it('should handle missing alt text', () => {
      const position = { page: 2, start: 100, end: 200 };
      const node = GraphFactory.createImageNode('', position);
  ...
  describe('createListNode', () => {
    it('should create an unordered list node', () => {
      ...
      const position = { page: 1, start: 0, end: content.length };
      const node = GraphFactory.createListNode(content, position, 3, 'unordered', 0.8);
    ...
    it('should create an ordered list node', () => {
      ...
      const position = { page: 1, start: 0, end: content.length };
      const node = GraphFactory.createListNode(content, position, 3, 'ordered');
  ...
  describe('createCodeNode', () => {
    it('should create a code block node with language', () => {
      ...
      const position = { page: 1, start: 0, end: content.length };
      const node = GraphFactory.createCodeNode(content, position, 'typescript', 0.9);
    ...
    it('should create a code block node without language', () => {
      ...
      const position = { page: 1, start: 0, end: content.length };
      const node = GraphFactory.createCodeNode(content, position);
  ...
  describe('createMetadataNode', () => {
    it('should create a metadata node', () => {
      const position = { page: 1, start: 0, end: 50 };
      const node = GraphFactory.createMetadataNode('author', 'John Doe', position, 1.0);
    ...
    it('should handle object values', () => {
      ...
      const node = GraphFactory.createMetadataNode('info', value, position);
  ...
  describe('edge creation helpers', () => {
    it('should create contains edge', () => {
      const edge = GraphFactory.createContainsEdge('parent', 'child', 0.9);
    ...
    it('should create follows edge', () => {
      const edge = GraphFactory.createFollowsEdge('prev', 'next');
    ...
    it('should create references edge', () => {
      const edge = GraphFactory.createReferencesEdge('source', 'target', 0.7, 'citation');
    ...
    it('should create similarity edge', () => {
      const edge = GraphFactory.createSimilarityEdge('node1', 'node2', 0.85, 'semantic');
