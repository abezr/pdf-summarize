...
const token_manager_1 = require("../../src/services/llm/token-manager");
describe('TokenManager', () => {
    let manager;
    beforeEach(() => {
        manager = new token_manager_1.TokenManager(100); // Small limit for testing
    });
    ...
    describe('recordUsage', () => {
        test('should record usage and return record', () => {
            ...
            const record = manager.recordUsage('gpt-4o', 'openai', 'test-operation', tokens, { test: true });
        ...
        test('should maintain record limit', () => {
            const manager = new token_manager_1.TokenManager(3);
            // Add 5 records
            for (let i = 0; i < 5; i++) {
